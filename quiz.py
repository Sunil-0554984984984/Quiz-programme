...
def play():
	print("\n==========QUIZ START==========")
	score = 0
	with open("D:/quiz-application-master/quiz-application-master/assets/questions.json", 'r+') as f:
		j = json.load(f)
		for i in range(10):
...
def createAccount():
	...
	with open('D:/quiz-application-master/quiz-application-master/assets/user_accounts.json', 'r+') as user_accounts: #The r+ mode is used to open a file for both reading and writing
